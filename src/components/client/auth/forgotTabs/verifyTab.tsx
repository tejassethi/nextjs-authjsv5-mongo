            ...
            {showResendButton ? (
              resendText === "" ? (
                <button
                  ...
                  className="w-full pt-2 select-none h-10 text-two hover:text-four underline text-lg text-black hover:text-green dark:text-white dark:hover:text-yellow-dark flex justify-center place-items-center cursor-pointer"
                >
